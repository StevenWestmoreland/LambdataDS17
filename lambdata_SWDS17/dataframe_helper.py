...
class My_Data_Splitter():
    ...
    def train_validation_test_splitter(self, train_size=0.7,
        ...
        train_test_split that splits arrays or matrices into
        ...
        Args:
            ...
            train_size (float or int): Proportion to include in train split.
            val_size (float or int): Proportion to include in validation split.
            test_size (float or int): Propoertion to include in test split.
            random_state (int): Controls pre-split shuffle for reproducibility.
    ...
    def date_divider(self, df, date_col):
        '''
        This function splits an existing datatime object into Year, Month,
        and Day features.
        Args:
            df (Numpy array or Dataframe): Object date_column belongs to.
            date_col (string): Name of the date_column to be split.
        Returns:
            Modified dataframe with the new Year, Month, and Day columns
            attached to the end.
        '''
...
class State_Standardization():
    ...
    def full_to_abbreviated(stateFullName):
        ...
        '''
        full_to_abbr = {'Alabama': 'AL', 'Alaska': 'AK',
                        ...
                        'Missouri': 'MO', 'Montana': 'MT', 'National': 'NA',
    ...
    def abbreviated_to_full(AB):
        '''
        This function takes a state abbreviation and returns
        the full state name.
        Args:
